  ...
  <div class="modal" id="modal-gudvangen">
    <div class="modal-dialog">
      <section class="modal-content">
        ...
        <p class="modal-presentation-description">Gudvangen is a village in Aurland Municipality in Vestland county, Norway. It is a popular tourist destination and is located at the end of the Nærøyfjord where the Nærøydalselvi river empties into the fjord. The European route E16 highway passes by the village.</p>
      </section>
    </div>
  </div>
  ...
  <div class="modal" id="modal-annecy">
    <div class="modal-dialog">
      <section class="modal-content">
        ...
        <p class="modal-presentation-description">Annecy is an alpine town in southeastern France, where Lake Annecy feeds into the Thiou River. It’s known for its Vieille Ville (old town), with cobbled streets, winding canals and pastel-colored houses. Overlooking the city, the medieval Château d’Annecy, once home to the Counts of Geneva, contains a museum with regional artifacts such as Alpine furniture and religious art, plus a natural history exhibit.</p>
      </section>
    </div>
  </div>
  ...
  <div class="modal" id="modal-brasov">
    <div class="modal-dialog">
      <section class="modal-content">
        ...
        <p class="modal-presentation-description">Brașov is a city in the Transylvania region of Romania, ringed by the Carpathian Mountains. It's known for its medieval Saxon walls and bastions, the towering Gothic-style Black Church and lively cafes. Piaţa Sfatului (Council Square) in the cobbled old town is surrounded by colorful baroque buildings and is home to the Casa Sfatului, a former town hall turned local history museum.</p>
      </section>
    </div>
  </div>
   ...
   <div class="modal" id="modal-terrasa">
    <div class="modal-dialog">
      <section class="modal-content">
        ...
        <p class="modal-presentation-description">Terrassa, is a city in the east central region of Catalonia, in the province of Barcelona, comarca of Vallès Occidental, of which it is the cocapital along with Sabadell.</p>
      </section>
    </div>
  </div>
